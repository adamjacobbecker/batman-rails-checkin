(function() {
  ...
  applyExtra = function(Batman) {
    ...
    return Batman.ModelPaginator = (function(_super) {
      ...
      ModelPaginator.prototype.loadItemsForOffsetAndLimit = function(offset, limit, cb) {
        var k, params, v, _ref,
          _this = this;
        ...
        return this.model.load(params, function(err, records, env) {
          if (err != null) {
            _this.markAsFinishedLoading();
            return _this.fire('error', err);
          } else {
            if (cb) cb(err, records, env);
            console.log(records);
